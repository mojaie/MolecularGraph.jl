...
sssr!(mol::SimpleMolGraph) = set_property!(
...
default_atom_charge!(mol::SimpleMolGraph) = set_property!(
...
default_bond_order!(mol::SimpleMolGraph) = set_property!(
...
apparent_valence!(mol::SimpleMolGraph) = set_property!(
...
valence!(mol::SimpleMolGraph) = set_property!(
...
lone_pair!(mol::SimpleMolGraph) = set_property!(
