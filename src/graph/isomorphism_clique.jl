...
ConstraintArrayMCIS{T,D,V,E}(data::JSON.Object{String,Any}) where {T,D,V,E} = ConstraintArrayMCIS{T,D,V,E}(
...
ConstraintArrayMCES{T,D,V,E}(data::JSON.Object{String,Any}) where {T,D,V,E} = ConstraintArrayMCES{T,D,V,E}(
    data["nv"], [(p...,) for p in data["pairs"]],
    data["distances"], data["vattrs1"], data["vattrs2"], data["eattrs"],
